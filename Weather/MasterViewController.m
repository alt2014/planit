...
- (void)viewDidLoad
{
    ...
    // Call geocode location on searched string as such - weather will contain all the relevant information for the next four love
    ...
    // NO ADDITIONAL CHANGES BELOW HERE
